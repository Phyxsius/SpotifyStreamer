 ...
 */
public class PlayerHelper implements Playback, AudioManager.OnAudioFocusChangeListener,
    ...
    public PlayerHelper(MusicService service, MusicProvider musicProvider) {
